...
export function AppHeader() {
  ...
  return (
    <header className='relative min-h-[50px] w-full bg-black lg:h-24'>
      <div
        className='container mx-auto flex h-full items-center justify-between'>
        <img src='/website-icons/logo.svg' />
        <div
          className='flex items-center justify-between gap-12 text-trafficWhite'>
          <NavItems items={items} />
          <div>
            <button className='text-primary-gradient p-4 font-Nexa font-bold'>
